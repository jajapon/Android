<?php
   ...
   $query = 'SELECT a.titulo, a.animeid, a.temporada, a.imagen, a.descripcion, a.idioma FROM listaanimesfavoritos laf, anime a WHERE username="'.$username.'" AND laf.animeid = a.animeid ORDER BY titulo';
