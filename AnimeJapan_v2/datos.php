<?php 
    ...
    $query_old = "SELECT * FROM capitulo WHERE animeid = 62 ORDER BY ncapitulo";
	...
	if($result = $connection_old->query($query_old)){
        echo "hola2";
     	while($row = $result->fetch_object()){
            echo "hola3";
     		if($connection_new->query("INSERT INTO capitulo VALUES(40,45,".$row->ncapitulo.",".$row->parte.",'".$row->url."')")){
     		}else{
