<?php 
    ...
    $query_old = "SELECT * FROM capitulo WHERE animeid = 50 ORDER BY ncapitulo";
	$connection_old->query("SET NAMES 'utf8'");
	if($result = $connection_old->query($query_old)){
     	while($row = $result->fetch_object()){
     		if($connection_new->query("INSERT INTO capitulo VALUES(18,23,".$row->ncapitulo.",".$row->parte.",'".$row->url."')")){
